...
{ 
options.UseSqlServer("Data Source=localhost;Initial Catalog=NZWalksAuthDb;Integrated Security=True;TrustServerCertificate=True;");
});
...
// Add Authentication to our services
